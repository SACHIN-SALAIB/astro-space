        ...
        <div className="container ">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center">
            <div className="space-y-3 xl:pr-36 p-4 border-l-2 border-b-2 border-l-sky-800 border-b-sky-800 ">
              ...
              >
           Astronomical and Scientific Data
              </h1>
              <p data-aos="fade-up" data-aos-delay="700">
              Provide real-time star charts and celestial navigation aids for space missions.
              Notify astronauts of upcoming astronomical events for observational experiments.
              </p>
             <a href=' https://science.data.nasa.gov/astrophysics-data/'>  <button
                data-aos="fade-up"
                data-aos-delay="900"
